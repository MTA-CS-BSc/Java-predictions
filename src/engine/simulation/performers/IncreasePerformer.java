...
public abstract class IncreasePerformer {
    ...
    private static void handle(World world, IncreaseAction action, SingleEntity on) throws Exception {
    ...
    public static void performAction(World world, IncreaseAction action, SingleEntity on) throws Exception {
