...
public abstract class SingleSimulationLog implements Serializable {
    ...
    public WorldState getLastWorldState() {
        return worldStatesByTicks.getLast();
    }
    ...
    public void enqueueWorldState(WorldState worldState) {
        worldStatesByTicks.addFirst(worldState);
    }

    public void enqueueWorldState(World world) {
        enqueueWorldState(new WorldState(world));
    }
